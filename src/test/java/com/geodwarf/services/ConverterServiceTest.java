...
public class ConverterServiceTest {
    ...
    private final String CORRECT_COORDINATES_SHORT = "12.44563212,41.96781604,0 12.44562437,41.96781583,0 12.44561823,41.96781776,0 12.44561648,41.96782113,0 ";
    ...
    public void whenNumberOfCoordinatesIsCorrectReturnExpectedJson() throws CoordinatesNumberException, CoordinatesFormatException{
        ...
        when(kmlCoordinates.getCoordinates()).thenReturn(CORRECT_COORDINATES_SHORT);
        //when
